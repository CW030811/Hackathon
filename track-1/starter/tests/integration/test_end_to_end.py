...
class IntegrationTests(unittest.TestCase):
    ...
    def test_unique_root_packaging_and_official_evaluator_unchanged(self):
        ...
        # Pin the scorer from team-source revision 0ddd965 without requiring
        # that repository's Git objects in an independent clone or ZIP export.
        self.assertEqual(hashlib.sha256((STARTER / "score.py").read_bytes()).hexdigest(),
                         "b62dbe060b200a155d66c5beca7da7a981b006f03bb594e3b1e2bde71ca91c0a")
