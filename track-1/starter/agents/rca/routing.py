        ...
        for index, model in enumerate(models):
            ...
            if status is None:
                try:
                    ...
                    # Only our validator's fixed messages, never provider text.
                    validation_error = str(exc)[:160] if isinstance(exc, ValueError) and not isinstance(exc, json.JSONDecodeError) else type(exc).__name__
