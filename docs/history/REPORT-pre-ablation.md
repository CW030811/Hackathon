# Historical pre-ablation report

This archived report describes earlier source revisions. Current results are in [REPORT.md](../../REPORT.md). Relative links are adjusted for this archive location.
